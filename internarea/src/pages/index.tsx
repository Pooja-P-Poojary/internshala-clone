...
export default function SvgSlider() {
  ...
  const slides = [
    { pattern: "pattern-1", titleKey: "slide1", bgColor: "bg-indigo-600" },
    { pattern: "pattern-2", titleKey: "slide2", bgColor: "bg-blue-600" },
    { pattern: "pattern-3", titleKey: "slide3", bgColor: "bg-purple-600" },
    { pattern: "pattern-4", titleKey: "slide4", bgColor: "bg-teal-600" },
  ];
    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-63g9.onrender.com/api/internship"),
          axios.get("https://internshala-clone-63g9.onrender.com/api/job"),
        ]);
