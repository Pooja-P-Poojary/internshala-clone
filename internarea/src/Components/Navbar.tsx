      ...
      <nav className="bg-white shadow-md">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 px-4 py-4 space-y-3">
            <Link href={"/internship"} onClick={() => setMobileMenuOpen(false)}>
              <div className="text-gray-700 py-2 border-b">{t("internships")}</div>
            </Link>
            <Link href={"/job"} onClick={() => setMobileMenuOpen(false)}>
              <div className="text-gray-700 py-2 border-b">{t("jobs")}</div>
            </Link>
            <Link href={"/publicfeed"} onClick={() => setMobileMenuOpen(false)}>
              <div className="text-gray-700 py-2 border-b">{t("publicFeed")}</div>
            </Link>
            <Link href={"/subscription"} onClick={() => setMobileMenuOpen(false)}>
              <div className="text-gray-700 py-2 border-b">{t("choosePlan")}</div>
            </Link>
            <Link href={"/resume"} onClick={() => setMobileMenuOpen(false)}>
              <div className="text-gray-700 py-2 border-b">{t("resumeBuilder")}</div>
            </Link>
            ...
            {user ? (
              <div className="flex items-center justify-between pt-3">
                ...
                <LanguageSelector />
                <Link href={"/forgotpassword"} onClick={() => setMobileMenuOpen(false)} className="text-sm text-blue-600 hover:underline">
                  Forgot Password?
                </Link>
              </div>
            ) : (
              <div className="space-y-3 pt-3">
                ...
                <a href="/adminlogin" className="block text-center text-gray-600 hover:text-gray-800">
                  Admin
                </a>
              </div>
            )}
